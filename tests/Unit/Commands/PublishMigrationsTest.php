...
class PublishMigrationsTest extends TestCase
{
    ...
    protected function setUp(): void
    {
         ...
         */
        $this->filesystem->copyDirectory(database_path('migrations'), database_path('tmp_migrations'));
    ...
    protected function tearDown(): void
    {
        ...
        $this->filesystem->copyDirectory(database_path('tmp_migrations'), database_path('migrations'));
        $this->filesystem->deleteDirectory(database_path('tmp_migrations'));
    ...
    public function test_calling_the_command_will_publish_the_migration_files()
    {
        ...
        $published_migrations = array_map(function (SplFileInfo $file) {
            return preg_replace('/^[0-9]{4}_[0-9]{2}_[0-9]{2}_[0-9]{6}_/', '', $this->removeStubExtension($file->getFilename()));
        },$this->filesystem->allFiles(database_path('migrations')));

        $this->assertEquals($migrations, $published_migrations);
    }
}